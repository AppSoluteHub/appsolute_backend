    ...
    static generateConversationalMessage(context) {
        const messages = {
            ...
            short_answer: [
                ...
                "A bit too short there! I need more depth to properly grade this. Explain your thinking in 2-5 sentences! ✍️",
            ...
            server_error: [
                ...
                "Server hiccup! 🌩️ Give me another chance - try that again!",
                "Technical difficulties! My bad. Can you retry that? 🛠️",
            ],
            validation_error: [
                "Hmm, I ran into trouble validating your answer. Mind trying again? 🤔",
                "My validation system glitched. Can you resubmit your answer? ⚙️",
