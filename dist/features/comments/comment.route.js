...
commentRouter.post("/", auth_middleware_1.default, commentController.createComment);
commentRouter.get("/:postId", auth_middleware_1.default, commentController.getCommentsByPostId);
commentRouter.put("/:id", auth_middleware_1.default, commentController.updateComment);
