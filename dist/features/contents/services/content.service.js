...
exports.fetchYouTubeVideosKids = exports.fetchYouTubeVideos = void 0;
const axios_1 = __importDefault(require("axios"));
const appError_1 = require("../../../lib/appError");
const API_KEY = process.env.YOUTUBE_API_KEY;
const CHANNEL_ID = process.env.CHANNEL_ID;
const KIDS_API_KEY = process.env.KIDS_YOUTUBE_API_KEY;
const KIDS_CHANNEL_ID = process.env.KIDS_CHANNEL_ID;
...
const fetchYouTubeVideosKids = async () => {
    try {
        const response = await axios_1.default.get("https://www.googleapis.com/youtube/v3/search", {
            params: {
                part: "snippet",
                channelId: KIDS_CHANNEL_ID,
                maxResults: 10,
                order: "date",
                key: KIDS_API_KEY,
            },
...
exports.fetchYouTubeVideosKids = fetchYouTubeVideosKids;
