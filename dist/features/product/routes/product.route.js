...
// isAdmin,
(0, validateRequest_1.validateRequest)(product_dto_1.createProductDto), productController.createProduct);
router.get('/', productController.getAllProducts);
router.get('/:id', productController.getProductById);
router.patch('/:id', auth_middleware_1.default, 
// isAdmin,
(0, validateRequest_1.validateRequest)(product_dto_1.updateProductDto), productController.updateProduct);
